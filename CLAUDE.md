...
> 設計判断の経緯は **adr/**、技術仕様・境界は **TECH_RULES.md / engawa-acp-spec.md**、動くタスクの在庫は **Backlog.md**。迷ったらそっちへ。
...
- `adr/`（0001〜0015）, `TECH_RULES.md`, `engawa-acp-spec.md`, `Backlog.md`
...
## 参照
- 設計判断と却下理由 → **adr/README.md**（0001〜0015）
- 動くタスクの在庫 → **Backlog.md**
- 技術仕様・規約・境界 → **TECH_RULES.md** / **engawa-acp-spec.md**
